...
export function makeRepairPlan(overrides: Partial<RepairPlan> = {}): RepairPlan {
  return {
    ...
    prerequisites: [],
    confirmationSource: { attemptId: "attempt-diagnosed-1", hypothesisConfirmedAt: t(0) },
    ...overrides
  };
}

export function activeRepairContext(
  planOverrides: Partial<RepairPlan> = {},
  contextOverrides: Partial<Omit<ActiveRepairPlanContext, "plan">> = {}
): ActiveRepairPlanContext {
  return { plan: makeRepairPlan(planOverrides), ...contextOverrides };
}
