...
/packages
  ...
  /db                  [built, schema+seed; persistence adapters built Phase 5C-1 (Autopsy/RepairPlan/MasteryState), Phase 4B-1 (Attempt), and Phase 4B-2 security fix (read-only QuestionReader over Question)] Prisma schema (full domain model), migrations, seed data, generated client, repository/adapter layer
